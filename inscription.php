		...
		<section class="page">
         ...
         <form method="POST" action="" id="inscription">
               ...
               <div class="mb-3"> 
                     ...
                     <input class="form-control" type="password" placeholder="Votre mot de passe" id="mdp1" name="mdp1" />
               </div>
               <div class="mb-3"> 
               ...
               <div class="mb-3"> 
                  ...
                  <input class="btn btn-primary" type="submit" name="envoyer" value="Je m'inscris" /><br><br>
