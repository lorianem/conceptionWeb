  ...
  <body>
    ...
    <div class="flex-container" style="margin : 40px;">
      ...
      <div class="button-container">
        ...
        <p> Dixit est un jeu de société créatif et enchanteur où les joueurs utilisent des cartes illustrées pour raconter 
            ...
            sont mélangées, révélées, puis les joueurs votent pour deviner la carte du conteur. L'objectif est d'obtenir un équilibre subtil 
    ...
    <div class="flex-container" style="margin : 40px;">
        <section class='center'>
            ...
            <img src="image/jeux/Catane.jpg" class="img-thumbnail" alt="Error"
            width="350px"
            height="80px">
        </section>
    ...
    <div class="flex-container" style="margin : 40px;">
        <section class='center'>
            ...
            <img src="image/jeux/Cluedo.jpg" class="img-thumbnail" alt="Error"
            width="350px"
            height="80px">
        </section>
    ...
    <div class="flex-container" style="margin : 40px;">
        <section class='center'>
            ...
            <img src="image/jeux/Mysterium.png" class="img-thumbnail" alt="Error"
            width="350px"
            height="80px">
        </section>
    ...
    <div class="flex-container" style="margin : 40px;">
        <section class='center'>
            ...
            <img src="image/jeux/The Game.jpg" class="img-thumbnail" alt="Error"
            width="350px"
            height="80px">
        </section>
    ...
    <div class="flex-container" style="margin : 40px;">
        <section class='center'>
            ...
            <img src="image/jeux/The Mind.jpg" class="img-thumbnail" alt="Error"
            width="350px"
            height="80px">
        </section>
        ...
        .heart-button {
          ...
          <p> "Mind" est un jeu de société minimaliste et stimulant qui teste la synchronisation mentale des joueurs. Chaque participant détient 
            ...
            l'intuition sont essentielles pour résoudre ce casse-tête mental. "Mind" offre une expérience unique de communication non verbale et 
            de connexion intuitive entre les joueurs. </p>
        </section>
    </div>
    ...
    <div class="flex-container" style="margin : 40px;">
        <section class='center'>
            ...
            <img src="image/jeux/When I Dream.jpg" class="img-thumbnail" alt="Error"
            width="350px"
            height="80px">
        </section>
